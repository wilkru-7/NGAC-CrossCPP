...
curl -s --globoff 'http://127.0.0.1:8001/epp/context_notify?context=[location_user:siteA,location_object:siteA]&token=epp_token'
...
curl -s --globoff 'http://127.0.0.1:8001/epp/context_notify?context=[location_user:siteA,location_object:siteB]&token=epp_token'
