...
curl -s -G "http://127.0.0.1:8001/paapi/loadpol" --data-urlencode "policyfile=POLICIES/cassociates_PDP.pl" --data-urlencode "token=admin_token"
...
curl -s "http://127.0.0.1:8001/paapi/combinepol?policy1=temp&policy2=cond_associates_PDP&combined=combined_policies&token=admin_token"
