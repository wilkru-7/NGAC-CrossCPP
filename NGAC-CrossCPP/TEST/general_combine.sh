...
echo 'Combining policies - Example 3 (Users + Objects + Associates Condition)'
curl -s "http://127.0.0.1:8001/paapi/combinepol?policy1=users&policy2=objects&combined=temp&token=admin_token"
...
curl -s "http://127.0.0.1:8001/pqapi/access?user=u1&object=o1&ar=book&cond=\[location_user=siteA,location_object=siteA\]"
curl -s "http://127.0.0.1:8001/pqapi/access?user=u2&object=o2&ar=book&cond=\[location_user=siteA,location_object=siteA\]"
curl -s "http://127.0.0.1:8001/pqapi/access?user=u3&object=o1&ar=book&cond=\[location_user=siteA,location_object=siteA\]"
curl -s "http://127.0.0.1:8001/pqapi/access?user=u3&object=o2&ar=book&cond=\[location_user=siteA,location_object=siteA\]"
curl -s "http://127.0.0.1:8001/pqapi/access?user=u4&object=o1&ar=book&cond=\[location_user=siteA,location_object=siteA\]"
curl -s "http://127.0.0.1:8001/pqapi/access?user=u4&object=o2&ar=book&cond=\[location_user=siteA,location_object=siteA\]"

curl -s "http://127.0.0.1:8001/pqapi/access?user=u1&object=o2&ar=book&cond=\[location_user=siteA,location_object=siteA\]"
curl -s "http://127.0.0.1:8001/pqapi/access?user=u2&object=o1&ar=book&cond=\[location_user=siteA,location_object=siteA\]"

curl -s "http://127.0.0.1:8001/pqapi/access?user=u1&object=o1&ar=book&cond=\[location_user=siteB,location_object=siteA\]"
curl -s "http://127.0.0.1:8001/pqapi/access?user=u3&object=o1&ar=book&cond=\[location_user=siteA\]"
curl -s "http://127.0.0.1:8001/pqapi/access?user=u3&object=o1&ar=book"