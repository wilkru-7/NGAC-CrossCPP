...
condition_predicate(site_and_business, [name, name]).
...
site_and_business(Site, Site) :- is_business_hours, is_same_site(Site, Site).
...
/* Translation from attribute to Int to be used in at_least_level(_,_) */
